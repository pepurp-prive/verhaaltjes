...
export function NavCard({
  ...
  const content = (
    <Card
      className={cn(
        'text-left p-6 rounded-2xl shadow-lg border border-transparent hover:shadow-xl hover:border-primary transition-all duration-300 transform hover:-translate-y-1 h-full',
